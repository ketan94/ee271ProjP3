...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/aroushan/ee271/ee271ProjP3/rtl/test_iterator.vp');
# START USER CODE FROM /home/aroushan/ee271/ee271ProjP3/rtl/test_iterator.vp PARSED INTO PACKAGE >>>
# line 1 "/home/aroushan/ee271/ee271ProjP3/rtl/test_iterator.vp"
...
print { $self->{OutfileHandle} } '			   .in({next_validSamp_R14H, next_isQuad_R14H, 1\'b1}) , ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '			   .clk(clk) , .reset(rst), .en(1\'b1),';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   //        next_sample_R14S    = 0  ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //        next_validSamp_R14H = 0';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //        next_isQuad_R14H    = 0';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //        next_state_R14H     = 0';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //        next_poly_R14S      = 0';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //        next_color_R14U     = 0 ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //        next_box_R14S       = 0';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //        next_halt_RnnnnL    = 1 ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/aroushan/ee271/ee271ProjP3/rtl/test_iterator.vp PARSED INTO PACKAGE
