...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/ketan94/ee271Project3/rtl/tree_hash.vp');
# START USER CODE FROM /home/ketan94/ee271Project3/rtl/tree_hash.vp PARSED INTO PACKAGE >>>
# line 1 "/home/ketan94/ee271Project3/rtl/tree_hash.vp"
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/ketan94/ee271Project3/rtl/tree_hash.vp PARSED INTO PACKAGE
