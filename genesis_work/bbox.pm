...
print { $self->{OutfileHandle} } '   //////// ASSIGN VALUES TO "box_R10S"';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  box_R10S [0][0]  = poly_R10S[0][0];     // min x    ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  box_R10S [0][1]  = poly_R10S[0][1];     // min y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  box_R10S [1][0]  = poly_R10S[0][0];    // max x';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  box_R10S [1][1]  = poly_R10S[0][1];    // max y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
    for (my $i = 1; $i < $verts; $i++) {
print { $self->{OutfileHandle} } '        box_R10S [0][0] = (poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][0] < box_R10S[0][0]) ? poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][0] : box_R10S[0][0]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '        box_R10S [0][1] = (poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][1] < box_R10S[0][1]) ? poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][1] : box_R10S[0][1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '        box_R10S [1][0] = (poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][0] > box_R10S[1][0]) ? poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][0] : box_R10S[1][0]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '        box_R10S [1][1] = (poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][1] > box_R10S[1][1]) ? poly_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } '][1] : box_R10S[1][1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   		';print { $self->{OutfileHandle} } "\n"; 
   }
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //////// PLACE YOUR CODE HERE';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      //////// ASSIGN FRACTION PORTION';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      rounded_box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:0]= {{'; print { $self->{OutfileHandle} } $alias_sig; print { $self->{OutfileHandle} } '{1\'b1}},{'; print { $self->{OutfileHandle} } $radix-$alias_sig; print { $self->{OutfileHandle} } '{0}}}; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   outvalid_R10H= 1\'b1;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  if (rounded_box_R10S[1][0] < 0 || rounded_box_R10S[1][1] < 0  || rounded_box_R10S[0][0] > screen_RnnnnS[0] || rounded_box_R10S[1][1] > screen_RnnnnS[1]) begin ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     outvalid_R10H = 1\'b0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  out_box_R10S[1][0] = rounded_box_R10S[1][0] > screen_RnnnnS[0] ? screen_RnnnnS[0] : rounded_box_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  out_box_R10S[1][1] = rounded_box_R10S[1][1] > screen_RnnnnS[1] ?screen_RnnnnS[1]  : rounded_box_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  out_box_R10S[0][0] = rounded_box_R10S[0][0] < 0 ? 0 : rounded_box_R10S[0][0]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  out_box_R10S[0][1] = rounded_box_R10S[0][1] < 0 ? 0 : rounded_box_R10S[0][1]; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '  ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
