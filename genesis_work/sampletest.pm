...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/home/aroushan/ee271/ee271ProjP3/rtl/sampletest.vp');
# START USER CODE FROM /home/aroushan/ee271/ee271ProjP3/rtl/sampletest.vp PARSED INTO PACKAGE >>>
# line 1 "/home/aroushan/ee271/ee271ProjP3/rtl/sampletest.vp"
...
print { $self->{OutfileHandle} } '     dist_lg_R16S[0] = poly_shift_R16S[0][0]*poly_shift_R16S[1][1] - poly_shift_R16S[1][0]*poly_shift_R16S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     dist_lg_R16S[1] = poly_shift_R16S[1][0]*poly_shift_R16S[2][1] - poly_shift_R16S[2][0]*poly_shift_R16S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     dist_lg_R16S[2] = poly_shift_R16S[2][0]*poly_shift_R16S[0][1] - poly_shift_R16S[0][0]*poly_shift_R16S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '     //'; print { $self->{OutfileHandle} } $b0; print { $self->{OutfileHandle} } ' = (dist_lg_R16S[0] < 0.0) || (dist_lg_R16S[0]==0.0); ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     //'; print { $self->{OutfileHandle} } $b1; print { $self->{OutfileHandle} } ' = dist_lg_R16S[1] < 0.0; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     //'; print { $self->{OutfileHandle} } $b2; print { $self->{OutfileHandle} } ' = dist_lg_R16S[2] <= 0.0; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '     //HIT_VALID_R16H = validSamp_R16H && '; print { $self->{OutfileHandle} } $b0; print { $self->{OutfileHandle} } ' && '; print { $self->{OutfileHandle} } $b1; print { $self->{OutfileHandle} } ' && '; print { $self->{OutfileHandle} } $b2; print { $self->{OutfileHandle} } ';';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '    ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end   ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /home/aroushan/ee271/ee271ProjP3/rtl/sampletest.vp PARSED INTO PACKAGE
