...
module bbox_unq1
  ...
  box_R10S [0][0]  = poly_R10S[0][0];     // min x    
  box_R10S [0][1]  = poly_R10S[0][1];     // min y
  box_R10S [1][0]  = poly_R10S[0][0];    // max x
  box_R10S [1][1]  = poly_R10S[0][1];    // max y
...
always_comb begin
  ...
  if (rounded_box_R10S[1][0] < 0 || rounded_box_R10S[1][1] < 0  || rounded_box_R10S[0][0] > screen_RnnnnS[0] || rounded_box_R10S[1][1] > screen_RnnnnS[1]) begin 
     outvalid_R10H = 1'b0;
  end
